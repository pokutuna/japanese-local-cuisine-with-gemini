...
class H2Agent:
    ...
    def __init__(self, reactor: ReactorBase, pool: H2ConnectionPool, context_factory: BrowserLikePolicyForHTTPS = ..., connect_timeout: Optional[float] = None, bind_address: Optional[bytes] = None) -> None: ...
...
class ScrapyProxyH2Agent(H2Agent):
    def __init__(self, reactor: ReactorBase, proxy_uri: URI, pool: H2ConnectionPool, context_factory: BrowserLikePolicyForHTTPS = ..., connect_timeout: Optional[float] = None, bind_address: Optional[bytes] = None) -> None: ...
    def get_endpoint(self, uri: URI): ...
    def get_key(self, uri: URI) -> Tuple: ...
