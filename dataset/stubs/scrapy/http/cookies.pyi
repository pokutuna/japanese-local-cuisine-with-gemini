...
class CookieJar:
    ...
    processed: int
    def __init__(self, policy: Incomplete | None = None, check_expired_frequency: int = 10000) -> None: ...
    def extract_cookies(self, response, request): ...
    def add_cookie_header(self, request) -> None: ...
    def clear_session_cookies(self, *args, **kwargs): ...
    def clear(self, domain: Incomplete | None = None, path: Incomplete | None = None, name: Incomplete | None = None): ...
    def __iter__(self): ...
...
class WrappedResponse:
    ...
    def info(self): ...
    def get_all(self, name, default: Incomplete | None = None): ...
